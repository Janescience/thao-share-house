<template>
  <LayoutAuthenticated>
    <SectionMain>
      ...
      <ModalDetailMemberReceives :idModalDetail="idModalDetail" v-model="modalDetail" button-label="ยืนยัน"
        has-cancel />
            ...
            <tr v-for="member in itemsPaginated" :key="member.memberId">
              ...
              <td class="before:hidden lg:w-6 whitespace-nowrap">
                <BaseButtons type="justify-start lg:justify-end" no-wrap>
                  ...
                  <BaseButton color="info" label="รายละเอียด" icon="magnify" small
                    @click="getToDayAmountReceiveDetail(member.memberId)" />
                </BaseButtons>
